          ...
          children: [
            ...
            Expanded(
              child: ListView(padding: const EdgeInsets.symmetric(vertical: 4), children: [
                ...
                _DrawerItem(Icons.auto_graph, '🆕 تقارير متقدمة v10.1',
    ...
    showDialog(
      ...
      builder: (c) => AlertDialog(
        ...
        content: const Column(mainAxisSize: MainAxisSize.min, children: [
          Text('📱 تطبيق التقارير المتقدمة v10.1'),
          Text('الإصدار: 10.1.0 (مساعد مستقل)'),
          Text('يقرأ من قاعدة بيانات تطبيق الإحصاء الأصلي عبر المزامنة'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // ── عنوان مضغوط ──────────────────────────
        titleSpacing: 0,
        title: const Text('تقارير متقدمة v10.1',
            style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
            icon: const Icon(Icons.auto_graph, size: 20),
            tooltip: 'تقارير v10.1',
