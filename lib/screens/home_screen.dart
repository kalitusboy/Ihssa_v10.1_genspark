...
class _HomeScreenState extends State<HomeScreen>
          ...
          children: [
            ...
            Expanded(
              child: ListView(padding: const EdgeInsets.symmetric(vertical: 4), children: [
                ...
                _DrawerSection('➕ إضافة وتعديل'),
                _DrawerItem(Icons.person_add_alt_1_outlined, 'إضافة مستفيد جديد',
                    Colors.green.shade700, () async {
                  Navigator.pop(context);
                ...
                _DrawerItem(Icons.auto_graph, '🆕 تقارير متقدمة v11.01',
                    Colors.deepPurple.shade700, () {
                  Navigator.pop(context);
                  Navigator.push(context,
                      MaterialPageRoute(
                          builder: (_) => const AdvancedV10Screen()));
                }),
                _DrawerItem(Icons.description_outlined, '📄 محضر المعاينة (PV)',
    ...
    showDialog(
      ...
      builder: (c) => AlertDialog(
        ...
        content: const Column(mainAxisSize: MainAxisSize.min, children: [
          Text('📱 تطبيق التقارير المتقدمة v11.01'),
          Text('الإصدار: 11.1.0 (مساعد مستقل)'),
          Text('دعم عربي RTL في PDF + إضافة/تعديل برامج ومستفيدين'),
          Text('ترتيب البرامج في التقارير مطابق لشاشة الإحصائيات'),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: _buildDrawer(),
      // ★ v11.01: زر عائم لإضافة مستفيد بسرعة
      ...
      appBar: AppBar(
        // ── عنوان مضغوط ──────────────────────────
        titleSpacing: 0,
        title: const Text('تقارير متقدمة v11.01',
            style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
            icon: const Icon(Icons.auto_graph, size: 20),
            tooltip: 'تقارير v11.01',
            onPressed: () => Navigator.push(context,
                MaterialPageRoute(builder: (_) => const AdvancedV10Screen())),
          ),
          IconButton(
            icon: const Icon(Icons.sync, size: 20),
            tooltip: 'مزامنة من هاتف المدير',
            onPressed: () async {
